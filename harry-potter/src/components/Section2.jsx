      ...
      <div className="houses-track" ref={trackRef}>
        {HOUSE_IDS.map((id, i) => {
          ...
          return (
            <div
              key={id}
              className={`house-card house-card--${id} ${
                activeIndex === i ? "is-active" : ""
              }`}
              onMouseEnter={() => setHoveredHouse(id)}
              onMouseLeave={() =>
                setHoveredHouse((current) => (current === id ? null : current))
              }
              style={{
                "--card-accent": houseData.accent,
                "--card-accent2": houseData.accent2,
                "--card-glow": houseData.glow,
              }}
            >
              ...
              <div className="house-card-content">
                <img
                  className="house-card-logo"
                  src={houseData.logo}
                  alt={`${houseData.name} crest`}
                />
