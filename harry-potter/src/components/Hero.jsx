    ...
    <section className="hero" id="hero" ref={containerRef}>
      ...
      <div className="hero-overlay">
        <div
          ...
          ref={(el) => (sceneRefs.current["scene-1"] = el)}
        >
        ...
        <div
          className="hero-scene"
          ref={(el) => (sceneRefs.current["scene-2"] = el)}
        >
          <h2>A Castle Wrapped in Mist</h2>
          <p>
            Beyond the dark lake, ancient stones hold a thousand years of magic.
          </p>
        </div>

        <div
          className="hero-scene"
          ref={(el) => (sceneRefs.current["scene-3"] = el)}
        >
          <h2>Through the Stained Glass</h2>
          <p>
            Candlelight flickers along corridors where portraits whisper of old
            tales.
          </p>
        </div>
        ...
        <div
          className="hero-scene"
          ref={(el) => (sceneRefs.current["scene-4"] = el)}
        >
        ...
        <div
          className="hero-scene"
          ref={(el) => (sceneRefs.current["scene-5"] = el)}
        >
