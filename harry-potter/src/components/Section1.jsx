    ...
    <section className="sorting" id="sorting" ref={sectionRef}>
      <div className="sorting-scene" ref={sceneRef}>
        ...
        <div className="sorting-stage">
          ...
          >
            <svg viewBox="0 0 200 200" className="hat-svg">
              ...
              />
              <path
                d="M70 128 C 90 120, 120 124, 134 134"
                fill="none"
                stroke="#2a1f12"
                strokeWidth="2"
              />
        ...
        {(phase === "revealing" || phase === "sorted") && houseData && (
          <div
            className={`sorting-overlay sorting-overlay--reveal ${
              phase === "sorted" ? "sorting-overlay--settled" : ""
            }`}
          >
            <h2
              className="sorting-house-name"
              style={{
                color: houseData.accent,
                textShadow: `0 0 40px ${houseData.glow}`,
              }}
            >
              {houseData.name}
            </h2>
